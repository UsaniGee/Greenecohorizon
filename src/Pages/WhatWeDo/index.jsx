...
const WhatWeDo = () => {
    const cardBg = useColorModeValue('white', 'gray.800');
      ...
      const whatWeDo = [
        ...
        { title: 'Clean Energy Finance and Carbon Markets', subtitle: 'We promote innovative financial tools like carbon credits, green bonds, and decentralized energy markets that support climate action and green investment.', img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943486/IMG_0839_hte0gv.jpg' },
        { title: 'Environmental Monitoring and Data Analytics', subtitle: 'We leverage AI, IoT, and satellite data to track environmental changes, predict climate impacts, and drive smarter, data-informed decisions.', img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943487/IMG_0841_ym5zwu.jpg' },
        { title: 'Sustainable Agriculture and Food Tech', subtitle: 'We promote innovative farming practices that reduce land use, conserve water, and improve food security, supporting healthier ecosystems.', img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943487/IMG_0842_htqv77.jpg' },
        { title: 'Energy Storage and Efficiency', subtitle: " We develop smart energy storage systems and efficiency technologies that reduce waste, stabilize the grid, and ensure clean energy is available when it's needed most.", img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943486/IMG_0844_mejjby.jpg' },
         { title: 'Carbon Capture, Utilization, and Storage (CCUS)', subtitle: " We support technologies that capture and reuse carbon emissions, transforming them into valuable products and reducing the carbon footprint of industries", img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943486/IMG_0845_bmbupk.jpg' },
          { title: 'Green Building and Urban Design', subtitle: "  We advocate for sustainable construction materials and smart city designs that reduce energy use and create healthier urban environments.", img: 'https://res.cloudinary.com/dnu4lxiie/image/upload/v1758943487/IMG_0846_r7ta0a.jpg' },
      ];
  return (
   <Box >
       {/* Header Section */}
